			...
			<div class="card-body">
				<form:form action="insert" method="post"
					...
					<div class="row">
						...
						<div class="col-4">
							<form:input path="shipCode" class="form-control" placeholder="SHIPMENT CODE" />
						</div>
						<div class="col-4">
							<!-- Error Messsage -->
						</div>
					...
					<div class="row">
						...
						<div class="col-4">
							<form:textarea path="shipDesc" class="form-control" placeholder="DISCRIPTION......."></form:textarea>
						</div>
						<div class="col-4">
							<!-- Error Messsage -->
						</div>
